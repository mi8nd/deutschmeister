...
self.addEventListener('fetch', (event) => {
    ...
    // 1. Bypass requests to external domains (Firebase, Google APIs, YouTube).
    ...
    // 2. Network First, Fallback to Cache for core assets (HTML, CSS, JS).
    ...
    // 3. Cache First, Fallback to Network for static assets (fonts, icons).
