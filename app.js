...
const setLanguage = async (lang) => {
    ...
    if (!allVideosData[lang] || Object.keys(allVideosData[lang]).length === 0) {
        ...
        try {
            ...
            allVideosData[lang] = {}; // Prevent retrying in the same session
        } finally {
            hideGlobalLoader();
        }
    }
...
const renderUserDashboard = () => {
    ...
    if (canonicalQuizData && typeof canonicalQuizData === 'object') {
        Object.values(canonicalQuizData).forEach(quiz => {
