...
async function handlePasswordReset(email) {
    try {
        // This URL is where the user will be redirected after a successful password reset.
        // NOTE: The domain of the link in the email itself is configured in your Firebase Console
        // under Authentication -> Templates -> Password reset. Make sure it is correct there.
