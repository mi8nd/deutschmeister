...
import { doc, setDoc, updateDoc, deleteDoc } from "https://www.gstatic.com/firebasejs/9.6.1/firebase-firestore.js";
...
async function handlePasswordReset(email) {
    try {
        ...
        if (error.code === 'auth/user-not-found') {
            // Do not reveal if an email address is registered or not
            return { success: true };
        }
        return { success: false, error: error.message };
    }
